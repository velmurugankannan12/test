...
import { fileURL } from '../../../services/apiconfig'
                                                        ...
                                                        <div className='w-12 h-12 rounded-full overflow-hidden'>
                                                            {
                                                                this.props.previewData.author.photo ?
                                                                    ...
                                                                    <img style={{ width: '100%', height: '100%', objectFit: 'cover' }} src={fileURL + this.props.previewData.author.photo} alt="Author" />
                                                                ...
                                                                <div className='flex gap-x-5'>
                                                                    <div className='w-12 h-12 rounded-full overflow-hidden'>
                                                                        {typeof e.data[0].img === 'string' && e.data[0].img.includes('/public/blog') ?
                                                                            <img className='w-full h-full object-contain' src={fileURL + e.data[0].img} alt="" />
                                                                            :
                                                                                    ...
                                                                                    secData.title === 'image' ?
                                                                                        <div className='w-11/12 overflow-hidden rounded-2xl my-2'>

                                                                                            {
                                                                                                typeof secData.content === 'string' && secData.content.includes('/public/blog') ?
                                                                                                    <img className='' src={fileURL + secData.content} alt="" />
                                                                                                    :
                                                                                        ...
                                                                                        secData.title === 'video' ?
                                                                                            <div className='w-11/12 overflow-hidden rounded-2xl my-2'>
                                                                                                {
                                                                                                    typeof secData.content === 'string' && secData.content.includes('/public/blog') ?
                                                                                                        <video controls className='' src={fileURL + secData.content} alt="" />
                                                                                                        :
