...
class Page extends Component {
    ...
    formatContent = (e) => {
        ...
        e = e.replace(/\{(\d*)sp\}/g, (match, number) => {
    ...
    componentDidMount() {
        ...
        const { editBlogData, setCategory, setSubCategory, setAuthor, setStickTop, setComment, setPubDate } = this.context
        ...
        setSubCategory(editBlogData.sub_category)
